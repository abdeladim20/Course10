...
public:
    clsDeveloper(int ID, string FirstName, string LastName, string Email, string Phone, string Title, string Department, float Salary, string MainProgrammingLanguage) : clsEmployee(ID, FirstName, LastName, Email, Phone, Title, Department, Salary) { _MainProgrammingLanguage = MainProgrammingLanguage; }
    // Property Set
...
int main()
{
    clsDeveloper Developer1(10, "Abdeladim", "Jabbouri", "abdeladimjabbouri@gmail.com", "8298982", "Web Developer", "N/V", 5000, "C++");
    Developer1.Print();
