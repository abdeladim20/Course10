...
public:
    ...
    // in the comming exercice i will solve the prametarized constructor with inheritance.
    clsPerson() {}
...
int main()
{
    ...
    Employee1.setFirstName("Abdeladim");
    Employee1.setLastName("Jabbouri");
    Employee1.setEmail("abdeladim@yahoo.com");
    Employee1.Print();
    Employee1.SendEmail("Hi", "How are you?");
    Employee1.setSalary(5000);
    cout << "Salary is: " << Employee1.Salary();
    // Calling the print will not print anything from derived class, only base class
    // therfore the print method will not serve me here, this is a problem will be solved in the next exercices.
    Employee1.Print();
