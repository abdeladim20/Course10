...

{
     ...
     cout << "Number of words: " << String1.CountWords("Fadi ahmed omar mohammed") << endl;

     cout << "Number of words: " << clsString::CountWords("Abdeladim jabbouri programming") << endl;
     ...
     cout << "Capital Letters count : "
          << clsString::CountLetters("Abdeladim programming", clsString::CapitalLetters)
          << endl
          << endl;

     //----------------

     String3.SetValue("Welcome to Morocco");
     cout << String3.GetValue() << endl;
     ...
     // Tirms
     String3.SetValue("    Abdeladim jabbouri     ");
     ...
     // Joins
     vector<string> vString1 = {"Abdeladim", "Faid", "Ali", "Maher"};

     cout << "\n\nJoin String From Vector: \n";
     cout << clsString::JoinString(vString1, " ");

     string arrString[] = {"Abdeladim", "Faid", "Ali", "Maher"};
     ...
     String3.SetValue("Abdeladim jabbouri jabbouri");
     cout << "\n\nString     = " << String3.GetValue();
     ...
     String3.SetValue("Abdeladim jabbouri jabbouri");
     cout << "\nReplace : " << String3.ReplaceWord("Abdeladim", "imran")
          << endl;
